...
namespace NSwag.Commands.CodeGeneration
{
        ...
        where TSettings : SwaggerToCSharpGeneratorSettings
   {
      ...
      [Argument(Name = "GenerateAspNetCore", IsRequired = false, Description = "Specifies whether to generate for .NET Core or .NET 4.")]
      public bool GenerateAspNetCore
      {
         get { return Settings.GenerateAspNetCore; }
         set { Settings.GenerateAspNetCore = value; }
      }
